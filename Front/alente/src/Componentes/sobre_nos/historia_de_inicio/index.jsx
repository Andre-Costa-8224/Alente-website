    ...
    <>
      <main>
        <section className="secaohistoria">
          <article className="imagem1">
            <img src={bebemamando} alt="bebê mamando" />
          </article>
          <article className="historia">
            ...
            <p>
              ...
              para bebês prematuros, mães impossibilitadas de amamentar,
              puérperias e afins. Com isso,
            </p>
            <p>
              Veja mais sobre nosso começo:{" "}
              <a
                href="http://globoplay.globo.com/v/8476809"
                target="_blank"
                rel="noreferrer noopener"
              >
                http://globoplay.globo.com/v/8476809
              </a>
            </p>
          </article>
          <article className="imagem2">
            <img
              src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSqbAtzSK8QupsEEbmjFr4NT43Ml7uzdiT-wA&usqp=CAU"
              alt="bebê mamando"
            />
          </article>
        </section>
        <section className="secaoimagem">
          <article>
            {imgs.map((img) => {
              return <img src={img} alt="instituto alente" />;
            })}
          </article>
        </section>
      </main>
